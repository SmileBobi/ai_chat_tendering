...
def create_qa_system(api_base=None, api_key=None, model_name="gpt-3.5-turbo", temperature=0.1, **kwargs):
    ...
    for index_path, json_path in [(bidding_index_path, bidding_json_path), (enterprise_index_path, enterprise_json_path)]:
        try:
...
[你的回答]
"""
    PROMPT = PromptTemplate(template=prompt_template, input_variables=["context_bidding", "context_enterprise", "question"])
...
if __name__ == "__main__":
    ...
    API_BASE = "https://dashscope.aliyuncs.com/compatible-mode/v1"   # 填写你的API地址
    MODEL_NAME = "qwen-max"
    # ==============================
